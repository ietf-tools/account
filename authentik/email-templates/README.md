...
> **Email changes** are handled separately by the app backend (SMTP), not an
> authentik Email stage — see the main [README.md](../../README.md) "Change email
> address". No template here is involved in that flow.
